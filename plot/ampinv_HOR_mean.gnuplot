set output 'ampinv_HOR_mean.eps'
...
load '< echo "set multiplot layout 2,1 title \"HORizontal amplitude invariant\\n\\n`grep -o -E "[ ]*title[ ]*[=:][ ]*[^[:cntrl:]]*" *.conf`\" "'

set title 'Amplitude invariant versus number of turns'
set xlabel 'Turn'
set ylabel 'ampinv'
plot 'ampinv_HOR_mean.dat' using 1:2 title 'Bunch center of mass', 'ampinv_HOR_mean.dat' using 1:3 title 'Bunch slices'
